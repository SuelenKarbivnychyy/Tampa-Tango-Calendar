...
class Event(db.Model):
    ...
    def __repr__(self):
        return f'<ID: {self.id} duration: {self.duration} description: {self.description} date: {self.date} price: {self.price} location: {self.location_id} event_type_id: {self.event_type_id}>'
